...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header">
        <div class="mdl-layout__header-row header-style">
            ...
            <nav class="mdl-navigation">
                <a class="mdl-navigation__link" href="dashboardApertamente.php">
    ...
    <div class="mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
            ...
            <a class="mdl-navigation__link" href="aggiungiCodiceSconto.php"><i class="material-icons md-ip">library_add</i>
