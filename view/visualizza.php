...
function visualizzaEsercente($variabile){
    ...
    <?php while ($row = mysqli_fetch_array($variabile, MYSQLI_ASSOC)) {
        ...
        echo '
        <div class="demo-card-image mdl-card mdl-shadow--2dp" style="background: url(' . ottieniImmagine($row['percorso_logo']) . ') center / cover; float: left; margin-left: 60px">
...
function doAggiungiEsercente($variabile){
    ...
    <div class="demo-card-wide mdl-card mdl-shadow--2dp">
        ...
        <div class="mdl-card__supporting-text">
            ...
            <label for="file" id="uploadfile" class="pr mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored">
